...
import CV from "../assets/cvword.docx";
    ...
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#020409] text-gray-300 z-50">
      ...
      <ul
        className={
          !nav
            ? "hidden"
            : "absolute top-0 left-0 w-full h-screen bg-[#020409] flex flex-col justify-center items-center"
        }
      >
